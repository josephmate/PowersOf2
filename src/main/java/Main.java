      ...
      """
          ...
          <body>
            ...
            <div>
              ...
              Should you waste your time trying to come up with a polynomial algorithm to solve the travelling salesman problem when your only has 10 nodes?
            </div>
            <h1>How to use</h1>
            <div>
              Use this table to estimate out the max complexity your algorithm can have in order to achieve some deadline.
              <ol>
            ...
            <div>
              ...
              <ol>
                ...
                <li>Coefficients and lower order terms of your algorithm's complexity (ex: N^2 vs 2*N^2)</li>
                <li>Concurrency</li>
